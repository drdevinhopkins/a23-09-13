...
import 'my_auth_model.dart';
export 'my_auth_model.dart';

class MyAuthWidget extends StatefulWidget {
  const MyAuthWidget({Key? key}) : super(key: key);
...
class _MyAuthWidgetState extends State<MyAuthWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyAuthModel());
